...
public class Notifications extends ActionBarActivity implements ApiCommunication{
    ...
    String callingActivity = "HomePage";
...
//        NotifList.setDivider(null);
        ...
        imgUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent hintent = new Intent(getApplicationContext(), Upload1.class);
    ...
    public void onBackPressed() {
        ...
        try {
            ...
            e.printStackTrace();
            dintent = new Intent(Notifications.this, HomePageNew.class);
            dintent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            dintent.putExtra("activity","SplashScreen");
            startActivity(dintent);
            finish();
...
//                            mydialog.putExtra("activity","Sell");
