...
public class customfragement extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        System.out.println("zzzz"+objectData.toString());
        ...
        try {
            ...
            viewPager.getLayoutParams().height = discover.screenWidth - 350;
            ...
            viewPager.setPadding(0, 10, (int) (discover.screenWidth * 0.15), 10);
