            ...
            admire.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (admire.getTag().toString().contains("Admiring")) {
                        ...
                        ApiService.getInstance(getActivity(), 1).postData((ApiCommunication) getActivity(), EnvConstants.APP_BASE_URL + "/user/admire/", admireObject, "discover", "unadmire");
                        ...
                        ApiService.getInstance(getActivity(), 1).postData((ApiCommunication) getActivity(), EnvConstants.APP_BASE_URL + "/user/admire/", admireObject, "discover", "admire");
...
//                    ImageView img = new ImageView(this);
            ...
            LinearLayout.LayoutParams closet_image_params = new LinearLayout.LayoutParams(discover.screenWidth - 150, discover.screenWidth - 150);
            ...
            Glide.with(getActivity())
                    ...
                    .crossFade()
                    .override(discover.screenWidth - 150, (int) ((discover.screenWidth - 150) * 1.333))
            ...
            view_inside_closet.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        Intent pro_page = new Intent(getActivity(), profile.class);
...
//            ---==============================
           ...
           viewPager.setPadding(0, 0, (int) (discover.screenWidth * 0.15), 0);
           ...
           viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
                ...
                public void onPageSelected(int position) {
                    if (position == 0) {
                       ...
                       viewPager.setPadding((int) (discover.screenWidth * 0.075), 0, (int) (discover.screenWidth * 0.075), 0);
                    } else if (position == closetPagerData.length() - 1) {
                       viewPager.setPadding((int) (discover.screenWidth * 0.15), 0, 0, 0);
                    }
                }
