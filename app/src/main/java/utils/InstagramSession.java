...
public class InstagramSession {
    ...
    private static final String API_PROFILE = "profile_picture";
     ...
     * @param username
     */
    public void storeAccessToken(String accessToken, String id, String username, String name,String profile) {
