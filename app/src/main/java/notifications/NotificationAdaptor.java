...
public class NotificationAdaptor implements ListAdapter {
    ...
    private class MyNotifViewHolder {
        ...
        ImageView first_profile_pic, second_profile_pic;
        ...
        public MyNotifViewHolder(View item) {
            ...
            first_profile_pic = (ImageView) item.findViewById(R.id.first_profile_pic);
            second_profile_pic = (ImageView) item.findViewById(R.id.second_profile_pic);
