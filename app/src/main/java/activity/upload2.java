 ...
 */
public class upload2 extends ActionBarActivity implements ApiCommunication {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(CommonFinish.broadcastReceiver, new IntentFilter("upload2"));
//        if(!MyApplicationClass.cContextArray.contains(getApplicationContext())) {
        ExternalFunctions.cContextArray[20] = upload2.this;
//        }
        progress = new ProgressDialog(upload2.this);
        ...
        try{
            ...
            Price = getIntent().getStringExtra("ListingPrice");
...
//    ----------------------------------------------------------
    ...
    public void displayAddress() {
        ...
        for (int i = 0; i < addressList.size(); i++) {
            LayoutInflater address_inflater = LayoutInflater.from(upload2.this);
            final View view;
...
//                rText.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.margin_15));
    ...
    public void onBackPressed() {
        if (!EditStatus) {
            Intent upload2 = new Intent(activity.upload2.this, upload1.class);
                ...
                if (s_state > 0) {
                    if (pincode.length() == 6) {
                        if (phone.length() >= 10) {
                            ...
                            CustomMessage.getInstance().CustomMessage(upload2.this, "Invalid phonenumber");

                        }
                    } else {
                        CustomMessage.getInstance().CustomMessage(upload2.this, "Invalid pincode");
                    }
                } else {
                    CustomMessage.getInstance().CustomMessage(upload2.this, "Select state");
                }

            } else {
                CustomMessage.getInstance().CustomMessage(upload2.this, "Fill all the fields");
            }
        } else {
            updateToServer();
        }
    ...
    private void updateToServer() {
        ...
        ApiService.getInstance(upload2.this, 1).putData(upload2.this, EnvConstants.APP_BASE_URL + "/address/crud/", addressObject, SCREEN_NAME, "Put");
...
//    -----------------------------------------------------------
    ...
    private void GetAddress() {
        ...
        ApiService.getInstance(upload2.this, 1).getData(upload2.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/address/crud/", "getdata");

    }


    private void GetStates() {
        ApiService.getInstance(upload2.this, 1).getData(upload2.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/address/get_states/", "getstates");
    }

    public void getEditData(int ProductId) {
        if (PTA) {
            ApiService.getInstance(upload2.this, 1).getData(upload2.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/upload/album/" + ProductId + "/3/?action=p_t_a", "getEditdata");
        } else {
            ApiService.getInstance(upload2.this, 1).getData(upload2.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/upload/album/" + ProductId + "/3/", "getEditdata");
        }
    }
    ...
    private void postAddress() {
        ...
        ApiService.getInstance(upload2.this, 1).postData(upload2.this, EnvConstants.APP_BASE_URL + "/address/crud/", addressObject, SCREEN_NAME, "Add");
    }
    ...
    public void upload_next3(View v) {
        if (selectedAddressId > 0) {
            ...
            if (!EditStatus) {
                ...
                ApiService.getInstance(upload2.this, 1).postData(upload2.this, EnvConstants.APP_BASE_URL + "/upload/album/" + ProductId + "/", albumObject, SCREEN_NAME, "postToserver");
            } else {
                final JSONObject albumObject = new JSONObject();
                try {
                    albumObject.put("pickup_address", selectedAddressId);
                ...
                if (PTA) {
                    ApiService.getInstance(upload2.this, 1).putData(upload2.this, EnvConstants.APP_BASE_URL + "/upload/album/" + ProductId + "/3/?action=p_t_a", albumObject, SCREEN_NAME, "editToserver");
                } else {
                    ApiService.getInstance(upload2.this, 1).putData(upload2.this, EnvConstants.APP_BASE_URL + "/upload/album/" + ProductId + "/3/", albumObject, SCREEN_NAME, "editToserver");
                }
            }
        } else {
            CustomMessage.getInstance().CustomMessage(upload2.this, "Select address");
        }
    }
            ...
            if (resp != null) {
                try {
                    ...
                    if (status.equals("success")) {
                        ...
                        progressbar.setVisibility(View.GONE);
                        Intent mydialog = new Intent(upload2.this, AlertActivity.class);
                        ...
                        mydialog.putExtra("activity", "upload2");
                        mydialog.putExtra("calling", "upload2");
...
//                        {"status":"error","detail":{"pincode":["This pincode is not available with ZAPYLE."]}}
                        ...
                        if (detail.has("pincode")) {
                            CustomMessage.getInstance().CustomMessage(upload2.this, detail.getJSONArray("pincode").get(0).toString());
                        }
            ...
            if (resp != null) {
                ...
                try {
                    ...
                    if (status.equals("success")) {
                        ...
                        HashMap<String, Object> upload_product = new HashMap<String, Object>();
                        upload_product.put("product_id", ProductId);
                        upload_product.put("price", Price);
                        upload_product.put("condition", Condition);
                        cleverTap.event.push("upload_product", upload_product);
                        if (GetSharedValues.getUsertype(upload2.this).equals("store_front")) {

                            Intent profile = new Intent(upload2.this, activity.profile.class);
...
//
//                            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(upload2.this);
...
//                                            Intent login = new Intent(upload2.this, MyProfile.class);
//                                            login.putExtra("zap_user", GetSharedValues.getZapname(upload2.this));
//                                            startActivity(login);
//                                            finish();
//
//                                        }
...
//                            // show it
//                            alertDialog.show();
                            Alerts.listingAlert(this, GetSharedValues.getZapname(upload2.this));
                            // finish();
                        }
            ...
            try {
                ...
                if (addaddressform.getVisibility() == View.VISIBLE) {
                    if (status.equals("success")) {
                        ...
                        CustomMessage.getInstance().CustomMessage(upload2.this, PincodeObject.getString("detail"));
                        a_city.setText("");
    ...
    protected void onRestart() {
        super.onRestart();
        if (!GetSharedValues.GetgcmId(upload2.this).equals("")) {
            ApiService.getInstance(upload2.this, 1).getData(upload2.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/user/session/?gcm_reg_id=" + GetSharedValues.GetgcmId(upload2.this), "session");
        } else {
            ApiService.getInstance(upload2.this, 1).getData(upload2.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/user/session/", "session");
        }
    }
    ...
    protected void onResume() {
        ...
        mTracker.setScreenName("upload2");
    ...
    private class PincodeAutofill extends AsyncTask<Integer, View, JSONObject> {
        ...
        protected JSONObject doInBackground(Integer... params) {
            ApiService.getInstance(upload2.this, 1).getData(upload2.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/address/pincode/?pincode=" + params[0], "pincodeAutofill");
