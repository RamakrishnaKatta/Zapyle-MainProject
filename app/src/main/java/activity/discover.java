...
public class discover extends ActionBarActivity implements ApiCommunication {
    public String SCREEN_NAME = "HOME_PAGE";
    JSONArray data = null;
    ...
    protected void onStart() {
        ...
        FeedSessioneditor.putString("FilteredHeading", "");
        ...
        CartSessioneditor.putBoolean("FromCart", false);
        CartSessioneditor.apply();
        if (ExternalFunctions.cartcount > 0) {
            System.out.printf("CART inside if : " + ExternalFunctions.cartcount);
            ...
            System.out.printf("CART inside else : " + CartSession.getInt("cartCount", 0));
        }

        System.out.println("RESUME : onstart");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("RESUME : oncreate");
...
//        ----------------------------------------------------
        ...
        if (checkPlayServices(discover.this)) {
...
//                Intent brand = new Intent(discover.this, category_list.class);
//                startActivity(brand);
//
//            }
//        });
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cart = new Intent(getBaseContext(), Cart.class);
                cart.putExtra("activity", "discover");
                startActivity(cart);
                finish();
        ...
        if (sharedpreferences.getString("homedata", "").toString().length() <= 1) {
            ...
            try {
                ...
                try {
                    ...
                    // HomeAsync obj=new HomeAsync( this,transaction);
//                        obj.execute(null,null,null);
    ...
    private void GetOverlay() {
        ApiService.getInstance(getBaseContext(), 1).getData(discover.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/marketing/overlay/discover", "getoverlay");
    }
...
//    ----------------------------------------------------
    ...
    private void GetData() {
        ApiService.getInstance(getBaseContext(), 1).getData(discover.this, true, SCREEN_NAME, EnvConstants.URL_HOME, "home");
    }
...
//    ----------------------------------------------------------
    ...
    public class DrawerAdaptor extends BaseAdapter {
        ...
        Boolean clickPrelovedStatus = false;
        Boolean clickBrandStatus = false;
        ...
        public void ShowmainList(RelativeLayout mainlayout) {
            ...
            System.out.println("LOGIN STATUS : " + GetSharedValues.LoginStatus(context));

            if (GetSharedValues.LoginStatus(context)) {
                bldrawtype = true;
                mainlayout.removeAllViews();
                final String[] mainArray = {"HOME", "SHOP BRAND NEW", "SHOP PRE LOVED", "EVENTS","SELL", "DISCOUNTS", "AUTHENTICITY", "MY PROFILE", "MY ACCOUNT", "ABOUT"};
...
//                                    finish();
                                        ...
                                        break;
                                    case "SHOP BRAND NEW":
                                        Intent intent_1 = new Intent(context, GenericMain.class);
                                        intent_1.putExtra("type","brand-new");
                                        intent_1.putExtra("heading","Shop Brand New");
                                        intent_1.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                                    ...
                                    case "SHOP PRE LOVED":
                                        Intent intent_2= new Intent(context, GenericMain.class);
                                        intent_2.putExtra("type","pre-loved");
                                        intent_2.putExtra("heading","Shop Pre Owned");
                                        intent_2.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                                        intent_2.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                        context.startActivity(intent_2);

                                        break;
                                    case "EVENTS":
                                        Intent intentX= new Intent(context, eventList.class);
                                        intentX.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                                    ...
                                    case "MY PROFILE":
                                        if (CheckConnectivity.isNetworkAvailable(context)) {
                                            if (GetSharedValues.LoginStatus(context)) {
                                                ...
                                                intent.putExtra("user_id", GetSharedValues.getuserId(discover.this));
                                                intent.putExtra("p_username", GetSharedValues.getUsername(discover.this));
                                                context.startActivity(intent);
                                               // finish();
                                                //Runtime.getRuntime().gc();
                                    ...
                                    case "DISCOUNTS":
                                        if (CheckConnectivity.isNetworkAvailable(context)) {
                                            if (GetSharedValues.LoginStatus(context)) {
                                                Intent myorders = new Intent(context, earn_cash.class);
                                                myorders.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                                                myorders.putExtra("activity", "discover");
...
//                                Alerts.InternetAlert(FeedPage.this);
                                    ...
                                    case "AUTHENTICITY":
                                        ...
                                        intent2.putExtra("activity", "discover");
...
//                                        tvIcon.setText(R.string.uparrow);
                ...
                bldrawtype = false;
                mainlayout.removeAllViews();
                final String[] mainArray = {"HOME", "SHOP BRAND NEW", "SHOP PRE LOVED", "EVENTS","SELL", "AUTHENTICITY", "LOGIN", "ABOUT"};
                for (int i = 0; i < mainArray.length; i++) {
                    try {
                        LayoutInflater comment_inflater = LayoutInflater.from(context);
                        final View view;
                        ...
                        switch (osArray[finalJ]) {
                            ...
                            case "STORY":
                                if (CheckConnectivity.isNetworkAvailable(context)) {
                                    ...
                                    intent1.putExtra("activity", "discover");
...
//                                Alerts.InternetAlert(getApplicationContext());
                            ...
                            case "FAQ":
                                ...
                                if (CheckConnectivity.isNetworkAvailable(context)) {
                                    ...
                                    intent5.putExtra("activity", "discover");
...
//                                Alerts.InternetAlert(getApplicationContext());
                            ...
                            case "CALL ZAPYLE":
                                ...
                                if (CheckConnectivity.isNetworkAvailable(context)) {
                                    ...
                                    intent.setData(Uri.parse("tel:" + "07337880282"));
                                    context.startActivity(intent);
//                                finish();
                                } else {
//                                Alerts.InternetAlert(getApplicationContext());
        ...
        public void ShowBrandNewBuy(final LinearLayout view) {
            final String[] osArray = {"DESIGNER", "BRANDS"};
            view.removeAllViews();
            LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
            lp.setMargins(40, 25, 10, 25);
            for (int j = 0; j < osArray.length; j++) {
                ...
                if (j == 0) {
                    ...
                    tvtext.setText("Buy & upload Luxury Fashion");
                }
                        ...
                        switch (osArray[finalJ]) {
                            ...
                            case "DESIGNER":
                                if (CheckConnectivity.isNetworkAvailable(context)) {
                                    ...
                                    Intent vintage = new Intent(getApplicationContext(), MainFeed.class);
                                    vintage.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                    vintage.putExtra("activity", "discover");
...
//                                Alerts.InternetAlert(getApplicationContext());
                            ...
                            case "BRANDS":
                                if (CheckConnectivity.isNetworkAvailable(context)) {
                                    ...
                                    Intent market = new Intent(getApplicationContext(), MainFeed.class);
                                    market.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        ...
        if (flag.equals("home")) {
            ...
            try {
                ...
                if (status.contains("success")) {
                    ...
                    LinearLayout ln = (LinearLayout) findViewById(R.id.lnnew);
                    manager = getSupportFragmentManager();//create an instance of fragment manager
                  //  FragmentTransaction transaction = manager.beginTransaction().setCustomAnimations(R.anim.hotline_slide_up,R.anim.slide_out_down);//c
                    ...
                    CustomMessage.getInstance().CustomMessage(discover.this, "Oops. Unable to load data");
                }
            } catch (JSONException e) {
                discover_progressBar.setVisibility(View.GONE);
                e.printStackTrace();
                                    ...
                                    public void run() {
                                        ...
                                        if (TimeCounter == intDelay) {
                                            ...
                                            try {
                                                ...
                                                ExternalFunctions.showOverlay(discover.this, strtilte, str_description, strbutton, activityname, bl_fullscreen, bl_close, strimage,str_uri);
                                            } catch (Exception e) {
...
//    ------------------------------------------------------
    public class MyUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {
        ...
        public void uncaughtException(Thread thread, Throwable ex) {
            //MyApplicationClass.sFirstRun= false;
            Intent intent = new Intent("discover");
    ...
    protected void onRestart() {
        ...
        if (!GetSharedValues.GetgcmId(getBaseContext()).equals("")) {
            ApiService.getInstance(getBaseContext(), 1).getData(discover.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/user/session/?gcm_reg_id=" + GetSharedValues.GetgcmId(getBaseContext()), "session");
        } else {
            ApiService.getInstance(getBaseContext(), 1).getData(discover.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/user/session/", "session");
        }
    }
