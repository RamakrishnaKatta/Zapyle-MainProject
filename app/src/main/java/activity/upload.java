 ...
 */
public class upload extends ActionBarActivity implements ApiCommunication, UploadReceiver.Receiver {
...
//    edit details------------
    ...
    String callingActivity = "MainFeed";
    Tracker mTracker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(CommonFinish.broadcastReceiver, new IntentFilter("upload"));
//        if(!MyApplicationClass.cContextArray.contains(getApplicationContext())) {
        ExternalFunctions.cContextArray[18] = upload.this;
...
//        }
        ...
        mProgress = new ProgressDialog(upload.this);
        //Appsee.start("4fb55809ab45411c909521bda720f8e6");
        screenSize = ExternalFunctions.displaymetrics(upload.this);
        ...
        try {
            ...
            callingActivity = "activity." + "MainFeed";
...
//        mixpanel.registerSuperPropertiesOnce(superprop);
        ...
        categorylayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (GetSharedValues.LoginStatus(upload.this)) {
                    if (next.getVisibility() == View.INVISIBLE) {
                        next.setVisibility(View.VISIBLE);
                    }
                    if (EditStatus) {
                        Intent brandAct = new Intent(upload.this, Category.class);
            ...
            public void onClick(View v) {
                ...
                if (GetSharedValues.LoginStatus(upload.this)) {
                    ...
                    if (selectedCategoryId != 0) {
                        ...
                        Intent brandAct = new Intent(upload.this, SizeguideActivity.class);
                        brandAct.putExtra("sizecategory", CategoryType);
                        brandAct.putExtra("user_type", GetSharedValues.getUsertype(upload.this));
                        startActivityForResult(brandAct, ACTION_REQUEST_SIZE_LIST);
                    } else {
                        CustomMessage.getInstance().CustomMessage(upload.this, "Select category");
                    }
                } else {
                    Alerts.loginAlert(upload.this);
                }
        ...
        brandlayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (GetSharedValues.LoginStatus(upload.this)) {
                    ...
                    if (EditStatus) {
                        Intent brandAct = new Intent(upload.this, BrandList.class);
                        brandAct.putExtra("EditStatus", true);
        ...
        occasionlayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (GetSharedValues.LoginStatus(upload.this)) {
                    ...
                    if (EditStatus) {
                        Intent brandAct = new Intent(upload.this, Occasion.class);
                        brandAct.putExtra("EditStatus", true);
        ...
        stylelayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (GetSharedValues.LoginStatus(upload.this)) {
                    ...
                    if (style_edit) {
                        Intent brandAct = new Intent(upload.this, Style.class);
                        brandAct.putExtra("EditStatus", true);
        ...
        colorlayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (GetSharedValues.LoginStatus(upload.this)) {
                    ...
                    if (color_edit) {
                        Intent brandAct = new Intent(upload.this, Colors.class);
                        brandAct.putExtra("EditStatus", true);
            ...
            switch (requestCode) {
                ...
                case ACTION_REQUEST_BRAND_LIST:
                    ...
                    if (selectedSizenames.size() > 0) {
                        ...
                        if (GetSharedValues.getUsertype(upload.this).equals("store_front")) {
...
//    progressBar.setVisibility(View.VISIBLE);
        ApiService.getInstance(upload.this, 1).getData(upload.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/marketing/overlay/upload", "getoverlay");
    }
        ...
        if (GetSharedValues.LoginStatus(upload.this)) {
            if (!EditStatus) {
                ...
                if (strvalidate.equals("true")) {
                    ...
                    CustomMessage.getInstance().CustomMessage(upload.this, strvalidate);
                }
            } else {
                next.setEnabled(false);
                if (!CategoryType.equals("FS")) {
                    if (sizeitemListToJsonConvert().length() > 0) {
                        ...
                        CustomMessage.getInstance().CustomMessage(upload.this, "Select size");
                    }
                } else {
                    postEditData();
                }
...
//        }
        ...
        ApiService.getInstance(upload.this, 1).postData(upload.this, EnvConstants.APP_BASE_URL + "/upload/album/", toserverData, SCREEN_NAME, "postfirstdata");
...
//        }
        ...
        //////System.out.println("objectcheck___" + toserverData);
        if (PTA) {
            ApiService.getInstance(upload.this, 1).putData(upload.this, EnvConstants.APP_BASE_URL + "/upload/album/" + ProductId + "/1/?action=p_t_a", toserverData, SCREEN_NAME, "posteditdata");

        } else {
            ApiService.getInstance(upload.this, 1).putData(upload.this, EnvConstants.APP_BASE_URL + "/upload/album/" + ProductId + "/1/", toserverData, SCREEN_NAME, "posteditdata");
...
//
        ...
        if (CheckMemory.CheckInternalMemory(bitmapSize)) {
            ...
            ExternalFunctions.AlbumCRUD_Shared(upload.this, String.valueOf(ProductId), String.valueOf(imageArray.length()), true);
            ...
            ApiService.getInstance(upload.this, 1).postData(upload.this, EnvConstants.APP_BASE_URL + "/upload/album/" + productId + "/", ImagetoServer, SCREEN_NAME, "postEditimagedata");
...
//
        ...
        if (CheckMemory.CheckInternalMemory(bitmapSize)) {
            ...
            ApiService.getInstance(upload.this, 1).postData(upload.this, EnvConstants.APP_BASE_URL + "/upload/album/" + productId + "/", ImagetoServer, SCREEN_NAME, "postimagedata");
    ...
    public void getDataToEdit(int ProductId) {
        progressBar.setVisibility(View.VISIBLE);
        if (PTA) {
            ApiService.getInstance(upload.this, 1).getData(upload.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/upload/album/" + ProductId + "/1/?action=" + "p_t_a", "getEditdata");
        } else {
            ApiService.getInstance(upload.this, 1).getData(upload.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/upload/album/" + ProductId + "/1/", "getEditdata");
        }
    }
                ...
                try {
                    ...
                    if (status.equals("success")) {
                        ...
                        if (selctedSale.equals("2")) {
                            ...
                            Intent upload2 = new Intent(upload.this, upload1.class);
                            ...
                            if (GetSharedValues.getUsertype(upload.this).equals("store_front")) {
                                Intent myprofile = new Intent(upload.this, profile.class);
...
//                ((Activity) context).finish();
                                ...
                                toprofile.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Intent login = new Intent(upload.this, profile.class);
                                        login.putExtra("user_id", GetSharedValues.getuserId(upload.this));
                                        login.putExtra("p_username", GetSharedValues.getUsername(upload.this));
//                                        login.putExtra("zap_user", GetSharedValues.getZapname(upload.this));
                                        startActivity(login);
                                        finish();
                                    }
                                });
                        ...
                        mProgress.dismiss();
                        next.setEnabled(true);
                        Intent mydialog = new Intent(upload.this, AlertActivity.class);
...
//                                                                    ExternalFunctions.showOverlay(MainFeed.this, "", "", "", activityname, bl_fullscreen, bl_close, strimage);
                                                ExternalFunctions.showOverlay(upload.this, strtilte, str_description, strbutton, activityname, bl_fullscreen, bl_close, strimage,str_uri);
                    ...
                    if (status.equals("success")) {
                        ...
                        if (selctedSale.equals("2")) {
                            ...
                            if (GetSharedValues.getUsertype(upload.this).equals("store_front")) {
                                ...
                                Alerts.listingAlert(this, GetSharedValues.getZapname(upload.this));
                            }
                        }
                        next.setEnabled(true);
                    } else {
                        ...
                        mydialog.putExtra("tip", "SOMETHING WENT WRONG");
                        mydialog.putExtra("activity", "upload");
                        mydialog.putExtra("calling", "upload");
                        startActivity(mydialog);
                        finish();
...
//                progressBar.setVisibility(View.GONE);
    ...
    public void onBackPressed() {
        ...
        if (CLICK_COUNT < 1) {
            ...
            CLICK_COUNT = 0;
            if (!EditStatus) {
                if (profile.loadtoupload == 1) {
                    profile.loadtoupload = 0;
                    Intent profile = new Intent(upload.this, activity.profile.class);
                    ...
                    Intent dintent = null;
                    try {
                        dintent = new Intent(upload.this, Class.forName(callingActivity));
                        ...
                        e.printStackTrace();
                        dintent = new Intent(upload.this, discover.class);
                        dintent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(dintent);
                        finish();
                    }
                ...
                if (ExternalFunctions.uploadbackcheck == 0) {
                    Intent styleinspiration = new Intent(upload.this, product.class);
                    ...
                    Intent dintent = new Intent(upload.this, MainFeed.class);
                    dintent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    dintent.putExtra("activity", "SplashScreen");
                    startActivity(dintent);
                    finish();
                    ...
                    if (profile.loadtoupload == 1) {
                        ...
                        profile.loadtoupload = 0;
                        Intent dintent = new Intent(upload.this, profile.class);
                        ...
                        Intent dintent = new Intent(upload.this, discover.class);
                        dintent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(dintent);
                        finish();
                    }
    ...
    protected void onRestart() {
        super.onRestart();
        if (!GetSharedValues.GetgcmId(upload.this).equals("")) {
            ApiService.getInstance(upload.this, 1).getData(upload.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/user/session/?gcm_reg_id=" + GetSharedValues.GetgcmId(upload.this), "session");
        } else {
            ApiService.getInstance(upload.this, 1).getData(upload.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/user/session/", "session");
        }
    }
