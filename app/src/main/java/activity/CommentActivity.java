...
//    changed
    ...
    String SCREEN_NAME = "COMMENT_PAGE";
...
//                                messagetext = message.getText().toString();
                        ...
                        Alerts.loginAlert(CommentActivity.this);
                    }
                } else {
                    Alerts.InternetAlert(CommentActivity.this);
                }
            }
        });
        ...
        if (click_count == 0) {
            ...
            if (C_Status) {
                ...
                try {
                    ...
                    mydialog = new Intent(CommentActivity.this, discover.class);
    ...
    private void showPopup(JSONArray data1) {
        ...
        for (int i = 0; i < data1.length(); i++) {
            ...
            try {
                ...
                ImageView image = (ImageView) view.findViewById(R.id.men_prof_pic);
