...
public class EmailLogin extends Activity implements ApiCommunication {
    ...
    private static final String SCREEN_NAME = "EMAIL_LOGIN";
...
//                            Intent onboarding5 = new Intent(EmailLogin.this, discover.class);
...
//                            finish();
                ...
                if (status.equals("success")) {
                    ...
                    if (processCompleted == 1) {
                        ...
                        if (!FromCart) {
                            ...
                            Intent onboarding5 = new Intent(EmailLogin.this, Cart.class);
                            startActivity(onboarding5);
                            finish();
                        }
                    }
    ...
    protected void onResume() {
        ...
        mTracker.setScreenName("Email login");
