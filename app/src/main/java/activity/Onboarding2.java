...
public class Onboarding2 extends ActionBarActivity implements ApiCommunication {
    ...
    String SCREEN_NAME = "ONBORADING2";
        ...
        if (arraySize >= 5) {
            if (arraySize == 5) {
                if (action) {
                    ...
                    AnimOnboard.ProgressBarAnimation anim = new AnimOnboard.ProgressBarAnimation(seekingProgress, 80, 100);
            ...
            if (action) {
                ...
                AnimOnboard.ProgressBarAnimation anim = new AnimOnboard.ProgressBarAnimation(seekingProgress, startStatus, seekStatus);
                anim.setDuration(600);
                seekingProgress.startAnimation(anim);
