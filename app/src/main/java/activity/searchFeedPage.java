...
public class searchFeedPage extends ActionBarActivity implements ApiCommunication {
    ...
    final String SCREEN_NAME = "SEARCH_FEED";
...
//        -------------------------------------------------
        ...
        rlladmore = (RelativeLayout) findViewById(R.id.rlladmore);
        rlladmore.setVisibility(View.GONE);
...
//        --------------------------------------------
        ...
        try {
          ...
          activityfrom=bundle.getString("activityfrom");
        } catch (Exception e) {
        ...
        recyclerView.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (!loading && lastVisibleItem == totalItemCount - 1) {
                    ...
                    rlladmore.setVisibility(View.VISIBLE);
                    feeds.add(null);
...
//    --------------------------------------------------------------
    ...
    public void onResponseCallback(JSONObject response, String flag) {
        ...
        if (flag.equals("feed")) {
            ...
            int totpage=0;
            try {
                totpage=response.getJSONObject("data").getInt("total_pages");
            } catch (JSONException e) {
                e.printStackTrace();
            }
            HashMap<String, Object> search = new HashMap<String, Object>();
            search.put("search_query", ExternalFunctions.strsearch);
            search.put("search_page", activityfrom);
            search.put("number_of_results", totpage);
            cleverTap.event.push("search", search);
...
//    }
    ...
    public void onBackPressed() {
        ...
        if (activityname.contains("SplashScreen")) {
            ...
            search.putExtra("activity", "discover");
            Runtime.getRuntime().gc();
