...
public class ForceUpdate extends Activity {
                    ...
                    public void run() {
                        ...
                        for (int i = 0; i < data.length(); i++) {
                            ...
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                                imageButtons[i].setBackground(ContextCompat.getDrawable(ForceUpdate.this, R.drawable.white_round_bg));
                            }
                        }
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                            imageButtons[position].setBackground(ContextCompat.getDrawable(ForceUpdate.this, R.drawable.black_round_bg));
                        }
                    }
                });
            }
    ...
    public void AddIndicators() {
        ...
        for (int i = 0; i < data.length(); i++) {
            ...
            if (i == 0) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                    imageButtons[i].setBackground(ContextCompat.getDrawable(ForceUpdate.this, R.drawable.black_round_bg));
                }
