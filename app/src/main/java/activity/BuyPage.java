...
//            System.out.println("query1" + "https:wwww.zapyle.com" + data.getPath() + "?" + data.getQuery());
        ...
        lv_designer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent designer = new Intent(getApplicationContext(), MainFeed.class);
    ...
    private void getParamFromUrl(String path, String strquery, String strpath) {
        ...
        if (strquery != null && !strquery.toLowerCase().contains("search")) {
            ...
            Intent intent_web_link = new Intent(getApplicationContext(), filtered.class);
            ExternalFunctions.ActivityParam = "base";
            ...
            Intent intent_web_link = new Intent(getApplicationContext(), MainFeed.class);
...
//        ------------------------------------------
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                customToast = new CustomToast(discover.this, "Cart is clicked");
...
//                    finish();
        ...
        search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                customToast = new CustomToast(discover.this, "Search is clicked");
...
//                getSupportActionBar().setTitle(mActivityTitle);
    ...
    public void ShowmainList(RelativeLayout mainlayout) {
        ...
        if (GetSharedValues.LoginStatus(this)) {
            ...
            final String[] mainArray = {"discover", "upload", "Buy", "My profile", "My Account", "Discounts", "Authenticity", "About"};
                        ...
                        switch (mainArray[finalI]) {
                            case "discover":
                                if (CheckConnectivity.isNetworkAvailable(getApplicationContext())) {
                                    ...
                                    Intent discover = new Intent(BuyPage.this, activity.discover.class);
                            ...
                            case "upload":
                                if (CheckConnectivity.isNetworkAvailable(getApplicationContext())) {
                                    if (GetSharedValues.LoginStatus(getApplicationContext())) {
                                        Intent intent = new Intent(BuyPage.this, upload.class);
...
//                                    finish();
                            ...
                            case "Discounts":
                                if (CheckConnectivity.isNetworkAvailable(getApplicationContext())) {
                                    if (GetSharedValues.LoginStatus(getApplicationContext())) {
                                        Intent myorders = new Intent(getApplicationContext(), earn_cash.class);
...
//                                        tvIcon.setText(R.string.uparrow);
            ...
            mainlayout.removeAllViews();
            final String[] mainArray = {"discover", "upload", "Buy", "Login", "Authenticity", "About"};
            for (int i = 0; i < mainArray.length; i++) {
                        ...
                        switch (mainArray[finalI]) {
                            case "discover":
                                if (CheckConnectivity.isNetworkAvailable(getApplicationContext())) {
                                    ...
                                    Intent discover = new Intent(getApplicationContext(), activity.discover.class);
                                    discover.putExtra("activity", "BuyPage");
                                    discover.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                                    startActivity(discover);
                                    finish();
...
//                                Alerts.InternetAlert(getApplicationContext());
    ...
    public void onBackPressed() {
        ...
        try {
            ...
            e.printStackTrace();
            Intent discover = new Intent(this, activity.discover.class);
