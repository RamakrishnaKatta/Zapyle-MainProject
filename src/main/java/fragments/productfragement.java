...
//                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(HomePageNew.screenWidth - 150, HomePageNew.screenWidth);
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams((int)(HomePageNew.screenWidth/2.5) - 30, (int)((HomePageNew.screenWidth/2.5)*1.333)+150);
                lp.setMargins(23, 5, 23, 5);
                ...
                product_collection_image.getLayoutParams().height = (int)(((HomePageNew.screenWidth/2.5) - 30)*1.333);
                product_collection_image.getLayoutParams().width = (int)(HomePageNew.screenWidth/2.5) - 30;
                ...
                try {
                    Glide.with(getActivity())
                            ...
                            .dontAnimate()
                            .override((int)(HomePageNew.screenWidth/2.5) - 30, (int)(((HomePageNew.screenWidth/2.5) - 30)*1.333))
                ...
                product_collection_image.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        new Handler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                try {
                                    Intent productPage = new Intent(getActivity(), ProductPage.class);
