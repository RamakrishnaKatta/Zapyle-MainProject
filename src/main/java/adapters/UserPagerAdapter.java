...
public class UserPagerAdapter extends PagerAdapter implements ApiCommunication{
    ...
    public Object instantiateItem(ViewGroup view, final int position) {
        ...
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams( HomePageNew.screenWidth - 100,  HomePageNew.screenWidth / 3);
        ...
        user_collection_linear_layout.getLayoutParams().height = ( HomePageNew.screenWidth / 3) - 20;
            ...
            user_collection_admire_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (user_collection_admire_button.getText().toString().contains("Admiring")) {
                        ...
                        ApiService.getInstance(context, 1).postData(UserPagerAdapter.this, EnvConstants.APP_BASE_URL + "/user/admire/", admireObject, "HomePageNew", "userunadmire");
//                                    user_collection_admire_button.setEnabled(false);
                        ...
                        ApiService.getInstance(context, 1).postData(UserPagerAdapter.this, EnvConstants.APP_BASE_URL + "/user/admire/", admireObject, "HomePageNew", "useradmire");
//                                    user_collection_admire_button.setEnabled(false);
                    }
                }
            });
            ...
            try {
                Glide.with(context)
                        ...
                        .crossFade()
                        .override(( HomePageNew.screenWidth / 3) - 20, ( HomePageNew.screenWidth / 3) - 20)
