...
//    ======================================
    ...
    public void onResponseCallback(JSONObject response, String flag) {
        ...
        if (flag.equals("feed")) {
//            if (Method.equals("MainPage")) {
//                if (db.getRecordsCount() == 0) {
//                    try {
//                        String data = response.toString().replace("'", "z*p*");
//                        String query = "insert into " + "FEED" + " (" + PAGE + ", " + BODY + ") values('" + pageNo + "', '" + data + "');";
...
//                Bundle bundle = new Bundle();
//                bundle.putSerializable("FeedList", temp);
//                bundle.putBoolean("DbStatus", dbStatus);
//                bundle.putString("Method", "MainPage");
//                System.out.println("STATUS FINISHED");
//                receiver.send(STATUS_FINISHED, bundle);
//            } else if (Method.equals("MorePage")) {
//                if (db.getRecordsCount() <= pageNo && !dbStatus) {
//                    try {
//                        String data = response.toString().replace("'", "z*p*");
//                        String query = "UPDATE FEED SET json = '" + data + "' WHERE pageno = " + pageNo;
//                        db.processData(query);
//                        dbStatus = false;
//                    } catch (Exception e) {
//                    }
...
//                Bundle bundle = new Bundle();
//                bundle.putSerializable("FeedList", temp);
//                bundle.putString("Method", "MorePage");
//                System.out.println("STATUS FINISHED");
//                receiver.send(STATUS_FINISHED, bundle);
//            } else
