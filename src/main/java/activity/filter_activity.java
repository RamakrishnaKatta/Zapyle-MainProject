...
public class filter_activity extends AppCompatActivity implements ApiCommunication{
    public String SCREEN_NAME = "FILTER";
...
//                    FilterStatus = false;
                ...
                if (!activity.contains("null")){
                    ...
                    Intent newintent = new Intent(getApplicationContext(), FilteredFeed.class);
                    ...
                    Intent newintent = new Intent(getApplicationContext(), BuySecondPage.class);
                    startActivity(newintent);
                    finish();
                }
            }
