   ...
   // DotsTextView dots;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tv_title.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent product = new Intent(OrderTrack.this, ProductPage.class);
    ...
    private void DisplayTracker(ArrayList<TrackerModel> trackerData) {
        ...
        for (int i = 0; i < trackerData.size(); i++) {
            ...
            if (i <= currentStep) {
                ...
                ball.setBackground(getResources().getDrawable(R.drawable.tracker_bg));
