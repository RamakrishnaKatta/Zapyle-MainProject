...
public class Signup extends Activity implements ApiCommunication {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mixpanel = MixpanelAPI.getInstance(Signup.this, getResources().getString(R.string.mixpanelToken));
...
//                        }
                    ...
                    if (status.equals("success")) {
                        ...
                        if (db.getTableRecordsCount("CART") > 0){
                            ...
                            if (profileComplted == 1) {
                                ...
                                Intent onboarding5 = new Intent(Signup.this, HomePageNew.class);
    ...
    protected void onResume() {
        super.onResume();
        mTracker.set("UserName", GetSharedValues.getUsername(getApplicationContext()));mTracker.set("ZapUsername", GetSharedValues.getZapname(getApplicationContext()));   mTracker.setScreenName("Email signup");
