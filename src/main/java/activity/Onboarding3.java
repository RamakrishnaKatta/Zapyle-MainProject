...
//        }
        ...
        mixpanel = MixpanelAPI.getInstance(Onboarding3.this, getResources().getString(R.string.mixpanelToken));
            ...
            if (resp != null) {
                try {
                    ...
                    if (status.equals("success")) {
                        ...
                        try {
                            propTagselected.put("Brands added", intBrandAdded);
                            propTagselected.put("Brands removed", intBrandremoved);
                            propTagselected.put("Event Name", "Brand selection changed");
                            mixpanel.track("Brand selection changed", propTagselected);
...
//        unbindDrawables(findViewById(R.id.onboarding3Layout));
    ...
    protected void onResume() {
        super.onResume();
        mTracker.set("UserName", GetSharedValues.getUsername(getApplicationContext()));mTracker.set("ZapUsername", GetSharedValues.getZapname(getApplicationContext()));   mTracker.setScreenName("Onboarding3");
