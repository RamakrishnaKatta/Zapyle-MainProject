...
//        if (Upload1.selectedSize.size()>0){
//            //////System.out.println("preselected size"+Upload1.selectedSize);
//            //////System.out.println("preselected qty"+Upload1.selectedQty);
//        }
        GetSizes();
...
//                    }
                    ...
                    if (selectedid.size() > 0) {
                        Upload1.selectedSize.clear();
                        Upload1.selectedQty.clear();
...
//---------------------------------------------------------------------------------------
                                ...
                                //////System.out.println("test==="+Upload1.selectedSize);

                                if (Upload1.selectedSize.size() > 0) {
                                    if (struser.equals("zap_user")) {
                                        for (int i = 0; i < Upload1.selectedSize.size(); i++) {
                                            if (!Upload1.selectedSize.get(i).equals("freesize")) {
                                                if (data.getJSONObject(j).getInt("id") == Integer.parseInt(Upload1.selectedSize.get(i))) {
                                                    if (Upload1.selectedSizeType.contains("UK")) {
                                                        ...
                                                        selectedid.add(String.valueOf(Upload1.selectedSize.get(i)));
                                                        selectedqty.add("UK " + String.valueOf(Upload1.selectedSize.get(i)) + "-" + String.valueOf(Upload1.selectedQty.get(i)));

                                                    } else if (Upload1.selectedSizeType.contains("US")) {
                                                        l2h[j].setBackgroundColor(Color.parseColor("#FFCDD2"));
                                                        ...
                                                        selectedid.add(String.valueOf(Upload1.selectedSize.get(i)));
                                                        selectedqty.add("US " + String.valueOf(Upload1.selectedSize.get(i)) + "-" + String.valueOf(Upload1.selectedQty.get(i)));
                                                        ...
                                                        selectedid.add(String.valueOf(Upload1.selectedSize.get(i)));
                                                        selectedqty.add("EU " + String.valueOf(Upload1.selectedSize.get(i)) + "-" + String.valueOf(Upload1.selectedQty.get(i)));
                                        ...
                                        for (int i = 0; i < Upload1.selectedSize.size(); i++) {
                                            if (data.getJSONObject(j).getInt("id") == Integer.parseInt(Upload1.selectedSize.get(i))) {
                                                if (Upload1.selectedSizeType.contains("UK")) {
                                                    ...
                                                    l2h[j].setBackgroundColor(Color.parseColor("#FFCDD2"));
                                                    tuk[j].setBackgroundColor(Color.parseColor("#ff7477"));
                                                    tuk[j].setText(tuk[j].getText().toString() + "-(" + Upload1.selectedQty.get(i) + ")");
                                                    selectedSizes.add("UK " + data.getJSONObject(j).getString("uk_size"));
                                                    selectedid.add(String.valueOf(Upload1.selectedSize.get(i)));
                                                    selectedqty.add("UK " + String.valueOf(Upload1.selectedSize.get(i)) + "-" + String.valueOf(Upload1.selectedQty.get(i)));
                                                    ...
                                                    l2h[j].setBackgroundColor(Color.parseColor("#FFCDD2"));
                                                    tus[j].setBackgroundColor(Color.parseColor("#ff7477"));
                                                    tus[j].setText(tus[j].getText().toString() + "-(" + Upload1.selectedQty.get(i) + ")");
                                                    selectedSizes.add("US " + data.getJSONObject(j).getString("us_size"));
                                                    selectedid.add(String.valueOf(Upload1.selectedSize.get(i)));
                                                    selectedqty.add("US " + String.valueOf(Upload1.selectedSize.get(i)) + "-" + String.valueOf(Upload1.selectedQty.get(i)));
                                                    ...
                                                    l2h[j].setBackgroundColor(Color.parseColor("#FFCDD2"));
                                                    teu[j].setBackgroundColor(Color.parseColor("#ff7477"));
                                                    teu[j].setText(teu[j].getText().toString() + "-(" + Upload1.selectedQty.get(i) + ")");
                                                    selectedSizes.add("EU " + data.getJSONObject(j).getString("eu_size"));
                                                    selectedid.add(String.valueOf(Upload1.selectedSize.get(i)));
                                                    selectedqty.add("EU " + String.valueOf(Upload1.selectedSize.get(i)) + "-" + String.valueOf(Upload1.selectedQty.get(i)));
