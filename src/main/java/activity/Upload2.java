...
//    ---------------------
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mixpanel = MixpanelAPI.getInstance(Upload2.this, getResources().getString(R.string.mixpanelToken));
...
//        if(!MyApplicationClass.cContextArray.contains(getApplicationContext())) {
        ExternalFunctions.cContextArray[19] = Upload2.this;
//        }
        ...
        conditionguide.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent cg = new Intent(Upload2.this, ConditionGuide.class);
                cg.putExtra("activity", "Upload2");
...
//                        fashionCalculator();
        ...
        ageSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                View view = Upload2.this.getCurrentFocus();
                if (view != null) {
...
//----------------------------------------------------------------
    ...
    private void GetData() {
        if(EditStatus){
            if(PTA) {
                ApiService.getInstance(Upload2.this, 1).getData(Upload2.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/catalogue/zapfashioncalculator/?p_id=" + ProductId + "&action=p_t_a", "getdata");
            }
            else {
                ApiService.getInstance(Upload2.this, 1).getData(Upload2.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/catalogue/zapfashioncalculator/?p_id=" + ProductId , "getdata");
    ...
    public void getEditData(int ProductId) {
        ...
        if (PTA) {
            ApiService.getInstance(Upload2.this, 1).getData(Upload2.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/upload/album/" + ProductId + "/2/?action=p_t_a", "getEditdata");
        } else {
            ApiService.getInstance(Upload2.this, 1).getData(Upload2.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/upload/album/" + ProductId + "/2/", "getEditdata");
        }
    }
            ...
            if (selectedOrgPrice.length() > 0 && !selectedOrgPrice.isEmpty() && selectedListPrice.length() > 0 && !selectedListPrice.isEmpty()) {
                if (Integer.parseInt(selectedOrgPrice) > 0 ) {
                    ...
                    if (!EditStatus) {
                     ...
                     CustomMessage.getInstance().CustomMessage(Upload2.this, "Invalid amount");
                }
            } else {
                 CustomMessage.getInstance().CustomMessage(Upload2.this, "Fill all fields");
            }
        } else {
            selectedOrgPrice = orgPrice.getText().toString();
            selectedListPrice = ListPrice.getText().toString();
...
//    --------------------------------------------------------------
    ...
    private void postData(JSONObject data) {
        ...
        ApiService.getInstance(Upload2.this, 1).postData(Upload2.this, EnvConstants.APP_BASE_URL + "/upload/album/" + ProductId + "/", data, SCREEN_NAME, "postdata");
    }
    ...
    private void editData(JSONObject data) {
        ...
        if (PTA) {
            ...
            ApiService.getInstance(Upload2.this, 1).putData(Upload2.this, EnvConstants.APP_BASE_URL + "/upload/album/" + ProductId + "/2/?action=p_t_a", data, SCREEN_NAME, "editdata");
        } else {
            ApiService.getInstance(Upload2.this, 1).putData(Upload2.this, EnvConstants.APP_BASE_URL + "/upload/album/" + ProductId + "/2/", data, SCREEN_NAME, "editdata");
        }
    }
                ...
                try {
                    ...
                    if (status.equals("success")) {
                        ...
                        if (EditStatus) {
                         ...
                         CustomMessage.getInstance().CustomMessage(Upload2.this, "Oops. Something went wrong!");
                    }
            ...
            if (resp != null) {
                ...
                try {
                    ...
                    if (status.equals("success")) {
                        ...
                        Intent upload3 = new Intent(Upload2.this, Upload3.class);
...
//
    ...
    public void onBackPressed() {
        if (!EditStatus) {
            Intent upload2 = new Intent(Upload2.this, Upload1.class);
            ...
            Intent upload1 = new Intent(Upload2.this, Upload1.class);
