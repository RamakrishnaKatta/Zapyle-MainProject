...
//            //Finally add item arrays for "A" and "B" to main list with key
    ...
    public void onBackPressed() {
        ...
        try {
            ...
            Runtime.getRuntime().gc();
            Intent refine = new Intent(searchnew.this, HomePageNew.class);
            refine.putExtra("activity", "HomePageNew");
            startActivity(refine);
            finish();
        }
...
//                    viewPager.setAdapter(adapter);
    ...
    protected void onResume() {
        super.onResume();
        mTracker.set("UserName", GetSharedValues.getUsername(getApplicationContext()));mTracker.set("ZapUsername", GetSharedValues.getZapname(getApplicationContext()));   mTracker.setScreenName("Search page");
