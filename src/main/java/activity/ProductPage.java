...
public class ProductPage extends ActionBarActivity implements ApiCommunication {

    //    edited
    String SCREEN_NAME = "PRODUCTPAGE";
...
//        LocalBroadcastManager.getInstance(this).registerReceiver(CommonFinish.broadcastReceiver, new IntentFilter("ProductPage"));
        //  ExternalFunctions.cContextArray[8] = ProductPage.this;
        progress = new ProgressDialog(ProductPage.this);
        ...
        try {
            ...
            if (getIntent().getStringExtra("ForwardUrl") != null || getIntent().getStringExtra("ForwardUrl").toString().isEmpty()) {
                ForwardUrl = EnvConstants.APP_BASE_URL + getIntent().getStringExtra("ForwardUrl");
                HomePageStatus = true;
            }
        } catch (Exception e) {
        ...
        mixpanel = MixpanelAPI.getInstance(ProductPage.this, getResources().getString(R.string.mixpanelToken));
        mixpanel1 = MixpanelAPI.getInstance(ProductPage.this, getResources().getString(R.string.mixpanelToken));
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent shopcart = new Intent(ProductPage.this, ShopCart.class);
...
//        -----------------------------------------------------------------
        ...
        profileImage = (RoundedImageView) findViewById(R.id.product_profileimage);
...
//                lvMore.setVisibility(View.GONE);
        ...
        lvAuthenticityLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (lvSizeDialog.getVisibility() == View.VISIBLE) {
                    ...
                    Intent bp = new Intent(ProductPage.this, BuyerProtection.class);
        ...
        lvReturnLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (lvSizeDialog.getVisibility() == View.VISIBLE) {
                    ...
                    Intent sr = new Intent(ProductPage.this, ShippingReturns.class);
                ...
                if (lvSizeDialog.getVisibility() == View.VISIBLE) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Animation logoMoveAnimation = AnimationUtils.loadAnimation(ProductPage.this, R.anim.indicator_anim);
        ...
        tvQminus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (lvSizeDialog.getVisibility() == View.VISIBLE) {
//                    if (GetSharedValues.LoginStatus(ProductPage.this)) {
                    if (selectedSize != null) {
                        if (Integer.parseInt(tvQuantity.getText().toString()) <= 1) {
//                            customToast = new CustomToast(ProductPage.this, "quantity is 0");
//                            qminus.setEnabled(false);
                        ...
                        CustomMessage.getInstance().CustomMessage(ProductPage.this, "Select size");

                    }
//                    } else {
//                        Alerts.loginAlert(ProductPage.this);
//                    }
                }
            }
        });
...
//                    }
    ...
    private void sizeGuideIntent() {
        if (CategoryType.contains("C")) {
            Intent guide = new Intent(ProductPage.this, SizeGuide.class);
            guide.putExtra("album_id", ALBUM_ID);
            guide.putExtra("pta", false);
            guide.putExtra("activity", "ProductPage");
...
//    =====================
    ...
    public void Share() {
        ...
        ShareSheetStyle shareSheetStyle = new ShareSheetStyle(ProductPage.this, "zapyle", "Check this out -" + tvProductname.getText().toString())
        ...
        branchUniversalObject.showShareSheet(ProductPage.this, linkProperties, shareSheetStyle, null);
    }
...
//    ====================
    ...
    public void EditAlbum(View v) {
        if (GetSharedValues.LoginStatus(ProductPage.this)) {
            Intent upload1 = new Intent(ProductPage.this, Upload1.class);
...
//    --------------------------------------------------------------
    ...
    public void DeleteAlert() {
        LayoutInflater layoutInflater = LayoutInflater.from(ProductPage.this);

        View promptView = layoutInflater.inflate(R.layout.input_dialog_delete_product, null);
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ProductPage.this);
    ...
    public void Delete() {
        if (GetSharedValues.LoginStatus(ProductPage.this)) {
            ...
            if (pta == true) {
                ApiService.getInstance(ProductPage.this, 1).deleteData(ProductPage.this, true, SCREEN_NAME, EnvConstants.URL_FEED + "/editproduct/" + ALBUM_ID + "/?action=p_t_a", "deleteAlbum");
            } else {
                ApiService.getInstance(ProductPage.this, 1).deleteData(ProductPage.this, true, SCREEN_NAME, EnvConstants.URL_FEED + "/editproduct/" + ALBUM_ID + "/", "deleteAlbum");
            }
        } else {
            Alerts.loginAlert(ProductPage.this);
        }
    ...
    public void displayImages() {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                sliderAdaptor = new SliderAdaptor(ProductPage.this, images);
...
//                }
            ...
            for (int i = 0; i < 5; i++) {
                ...
                params.setMargins(5, 0, 5, 0);
                linearLayout1.setLayoutParams(params);
                int limit = (i + 1) * buttonwidth;

                if (limit < SizeTable.size()) {
                    final_limit = limit;
                } else if (limit == SizeTable.size()) {
                    final_limit = limit;
                } else {
                    if (limit != 0) {
                        final_limit = SizeTable.size() - (limit - buttonwidth);
                    }
                }


                for (int j = buttonwidth * i; j < final_limit; j++) {
...
//                if(final_limit < SizeTable.size()) {
                    ...
                    try {
                        if (size_type.equals("UK")) {
                            size = size_type + "-" + SizeTable.get(j).getString("uk_size");
                        } else if (size_type.equals("US")) {
                            size = size_type + "-" + SizeTable.get(j).getString("us_size");
                        } else if (size_type.equals("EU")) {
                            size = size_type + "-" + SizeTable.get(j).getString("eu_size");
                        }
                        sizeId = SizeTable.get(j).getInt("id");
                        ...
                        btn.setText(size);
                        btn.setTag(sizeId);
                        System.out.println("SIZE_TABLE:" + SizeTable.size() + "__" + sizeId + "___" + btn.getTag().toString());
...
//                            if (GetSharedValues.LoginStatus(ProductPage.this)) {
                            ...
                            if (selectedSize != null) {
                                ...
                                if (selectedSize.toString().equals(btn.getTag().toString())) {
                                    ...
                                    product_size = btn.getText().toString();
                                    if (getCartCount() > 0) {
                                        CustomMessage.getInstance().CustomMessage(ProductPage.this, "This item is already in your tote.");
    ...
    public void p_comment(View v) {
        if (GetSharedValues.LoginStatus(ProductPage.this)) {
            Intent comment = new Intent(ProductPage.this, CommentActivity.class);
            comment.putExtra("activity", "ProductPage");
    ...
    private void GetOverlay() {
        ...
        ApiService.getInstance(ProductPage.this, 1).getData(ProductPage.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/marketing/overlay/product", "getoverlay");
    }
    ...
    public void conditionguide(View v) {
        ...
        Intent cg = new Intent(ProductPage.this, ConditionGuide.class);
        cg.putExtra("activity", "ProductPage");
            ...
            if (BuyCheck == 0) {
                if (cursor.getCount() == 0) {
                    if (lvSizeDialog.getVisibility() == View.GONE) {
                        ...
                        CustomMessage.getInstance().CustomMessage(ProductPage.this, "Select your size");
                    }
                } else {
//                    SizeDialoge();
                    CustomMessage.getInstance().CustomMessage(ProductPage.this, "This item is already in your tote.");
                ...
                if (selectedSize != null) {
                    if (Qty > 0) {
                        ...
                        BuyCheck = 0;
                        CustomMessage.getInstance().CustomMessage(ProductPage.this, "Invalid quantity");
                    }
                } else {
                    BuyCheck = 0;
                    CustomMessage.getInstance().CustomMessage(ProductPage.this, "Select your size");
                ...
                Intent checkout = new Intent(ProductPage.this, ShopCart.class);
...
//            //////System.out.println("inside like click");
            ...
            ApiService.getInstance(ProductPage.this, 1).postData(ProductPage.this, EnvConstants.APP_BASE_URL + "/user/like_product/", likeObject, SCREEN_NAME, "like");
            ...
            lvMainlovelayout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent gotoLike = new Intent(ProductPage.this, LikersActivity.class);
    ...
    public void p_unlike() {
        if (GetSharedValues.LoginStatus(ProductPage.this)) {
            ...
            ApiService.getInstance(ProductPage.this, 1).postData(ProductPage.this, EnvConstants.APP_BASE_URL + "/user/like_product/", likeObject, SCREEN_NAME, "unlike");
...
//    ---------------------------------------------------------------
    ...
    private void GetProductdata(Integer ALBUM_ID) {
        ...
        overlaystatus = false;
        if (HomePageStatus) {
            ApiService.getInstance(ProductPage.this, 1).getData(ProductPage.this, true, SCREEN_NAME, ForwardUrl, "getproductdata");
        } else {

            if (ExternalFunctions.strOverlayactivity.equals("ProductPage") && ExternalFunctions.strOverlayurl.length() > 0) {
                ApiService.getInstance(ProductPage.this, 1).getData(ProductPage.this, true, SCREEN_NAME, ExternalFunctions.strOverlayurl, "getproductdata");
                ...
                if (pta == true) {
                    ...
                    ApiService.getInstance(ProductPage.this, 1).getData(ProductPage.this, true, SCREEN_NAME, EnvConstants.URL_FEED + "/singleproduct/" + ALBUM_ID + "/an/?action=p_t_a", "getproductdata");
                } else {
                    //System.out.println("overlay url" + EnvConstants.URL_FEED + "/singleproduct/" + ALBUM_ID + "/an/");
                    ApiService.getInstance(ProductPage.this, 1).getData(ProductPage.this, true, SCREEN_NAME, EnvConstants.URL_FEED + "/singleproduct/" + ALBUM_ID + "/an/", "getproductdata");
                }
            }
        }
...
//            buyList.put(buyObject);
        ...
        AddToDb(false);
        ApiService.getInstance(ProductPage.this, 1).postData(ProductPage.this, EnvConstants.APP_BASE_URL + "/zapcart/", buyObjectcart, SCREEN_NAME, "buy");
    }
...
//    ---------------------------------------------------------
    ...
    public void productAdmire(View v) {
        ...
        try {
            propTagselected.put("username", profile_user_name);
            propTagselected.put("Event Name", "Admire user");
            mixpanel1.track("Admire user", propTagselected);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        if (GetSharedValues.LoginStatus(ProductPage.this)) {
            if (AdmireStatus) {
                ...
                ApiService.getInstance(ProductPage.this, 1).postData(ProductPage.this, EnvConstants.APP_BASE_URL + "/user/admire/", admireObject, SCREEN_NAME, "unadmire");
                ...
                ApiService.getInstance(ProductPage.this, 1).postData(ProductPage.this, EnvConstants.APP_BASE_URL + "/user/admire/", admireObject, SCREEN_NAME, "admire");
                tvAdmire.setEnabled(false);
...
//                }
                ...
                switch (userType) {
                    case "store_front":
                        ...
                        lvMore.setVisibility(View.GONE);
                        if (ProfileUserId != GetSharedValues.getuserId(ProductPage.this)) {
...
//                        tvFlashSaleTitle.setText(data.getJSONObject("flash_sale_data").getString("sale_name"));
                    ...
                    if (tvDiscount.getVisibility() == View.VISIBLE) {
                        tvDiscount.setBackground(getResources().getDrawable(R.drawable.discount_bg));
                    }
                    lvFlashsaleLayout.setVisibility(View.GONE);
                }
                tvUsername.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try {
                            Intent pro_page = new Intent(ProductPage.this, ProfilePage.class);
                            pro_page.putExtra("user_id", data.getJSONObject("user").getInt("id"));
                            pro_page.putExtra("activity", "ProductPage");
...
//                }
                ...
                progressBar.setVisibility(View.GONE);
                CustomMessage.getInstance().CustomMessage(ProductPage.this, "Oops. Something went wrong!");
            }
        } catch (JSONException e) {
            e.printStackTrace();
            progressBar.setVisibility(View.GONE);
                                ...
                                runOnUiThread(new Runnable() {
                                    public void run() {
                                        ...
                                        if (TimeCounter == intDelay) {
                                            ...
                                            t.cancel();
                                            try {
                                                ExternalFunctions.showOverlay(ProductPage.this, strtilte, str_description, strbutton, activityname, bl_fullscreen, bl_close, strimage);
                                            } catch (Exception e) {
...
//                        lvLikeplaceholder.setVisibility(View.VISIBLE);
            ...
            if (resp != null) {
                ...
                try {
                    ...
                    if (status.equals("success")) {
                        ...
                        Intent myprofile = new Intent(ProductPage.this, ProfilePage.class);
    ...
    protected void onDestroy() {
        ...
        System.out.print("xcsdsdsDestroy");
        Mixpanelutils mx = new Mixpanelutils();

        ////System.out.println("mixpaneltimespent" + mx.getTimeDiff(starttime, strclosetime) + "iii" + strclosetime+"==="+starttime);

        JSONObject superprop = new JSONObject();
        try {
            superprop.put("Time spent on Product page", mx.getTimeDiff(starttime, strclosetime));
            superprop.put("Event Name", "Left product page");
            mixpanel.track("Left product page", superprop);
        } catch (JSONException e) {
            e.printStackTrace();
        }
...
//        unbindDrawables(findViewById(R.id.onboarding3Layout));
    ...
    public void onLowMemory() {
        ...
        ExternalFunctions.deleteCache(ProductPage.this);
    }
    ...
    public void onBackPressed() {
        ...
        try {
            mydialog = new Intent(ProductPage.this, Class.forName(callingActivity));
            ...
            if (ExternalFunctions.blapplysearch) {
                mydialog = new Intent(ProductPage.this, searchFeedPage.class);
                ...
                finish();
            } else if (ExternalFunctions.dicActivity == "BuySecondPage") {
                mydialog = new Intent(ProductPage.this, BuySecondPage.class);
                mydialog.putExtra("activity", "SplashScreen");
                startActivity(mydialog);
                finish();
            } else {
                mydialog = new Intent(ProductPage.this, HomePageNew.class);
                mydialog.putExtra("activity", "SplashScreen");
                //mydialog.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                startActivity(mydialog);
                finish();
    ...
    protected void onRestart() {
        super.onRestart();
        if (!GetSharedValues.GetgcmId(ProductPage.this).equals("")) {
            ApiService.getInstance(ProductPage.this, 1).getData(ProductPage.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/user/session/?gcm_reg_id=" + GetSharedValues.GetgcmId(ProductPage.this), "session");
        } else {
            ApiService.getInstance(ProductPage.this, 1).getData(ProductPage.this, true, SCREEN_NAME, EnvConstants.APP_BASE_URL + "/user/session/", "session");
        }
    }
...
//                    .into(imageView);
            ...
            //  System.out.println("SIZESSSS : " + GetSharedValues.getScreenWidth(context) + "------" + (int) (GetSharedValues.getScreenWidth(context) * 1.333));

            imageView.getLayoutParams().height = GetSharedValues.getScreenWidth(context);
            imageView.getLayoutParams().width = (int) ((GetSharedValues.getScreenWidth(context)) * 0.75);
            imageView.setScaleType(ImageView.ScaleType.FIT_XY);
